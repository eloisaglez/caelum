...
- [ ] Verificar que se crea `datos_SD_raw.csv` en la MicroSD
...
- [ ] Extraer MicroSD — copiar `datos_SD_raw.csv` al portátil
...
- [ ] Verificar que los tres ficheros tienen datos:
  - [ ] `datos_SD_raw.csv`  (datos crudos SD)
  - [ ] `datos_RAM.csv`      (backup RAM)
  - [ ] `datos_radio.csv`    (seguro crítico)
  - [ ] `datos_RAM.csv`
  - [ ] `datos_radio.csv`
