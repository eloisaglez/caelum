...
ALT_INVERSION_BASE = 0     # Sin inversión
ALT_INVERSION_TOPE = 0     # Sin inversión
GRADIENTE_INVERSION = 6.5  # Igual que gradiente normal — no hay inversión
...
#
#  PM2.5: bajo y uniforme en todo el perfil — sin fuentes locales ni inversión
# ──────────────────────────────────────────────────────────────

# CO₂ ~420 ppm constante en todo el perfil — fondo atmosférico global.
# A ~1000m las fuentes del suelo no son detectables.
# Solo se añade ruido de sensor (SCD40 precisión ±10 ppm).
# Sin contaminación — PM2.5 bajo y uniforme en todo el perfil
# No hay inversión térmica — gradiente normal en todas las altitudes
PERFIL_CONTAMINACION = [
    # (alt_min, alt_max, co2_base, pm25_base, descripcion)
    (700, 1000, 420, 4,  "Aire limpio"),
    (500, 700,  420, 5,  "Aire limpio"),
    (350, 500,  420, 6,  "Aire limpio"),
    (200, 350,  420, 7,  "Aire limpio — sin acumulación"),
    (100, 200,  420, 8,  "Aire limpio"),
    (0,   100,  420, 9,  "Capa superficial — sin contaminación"),
]
...
def simular_vuelo():
    print("═" * 60)
    print("   🚀 SIMULADOR — ESCENARIO: SIN CONTAMINACIÓN")
    print("═" * 60)
    ...
    print(f"✅ Sin inversión térmica — gradiente normal en todo el perfil")
    ...
    print(f"\n💡 Siguiente paso:")
    print(f"   python analizar_vuelo.py {OUTPUT_FILE}  # No debe detectar ninguna inversión")
    print("\n" + "═" * 60)
