...
============================================================
  ...
  Ejemplos:
      ...
      python generar_kml.py datos_RAM.csv
      python generar_kml.py datos_simulacion.csv
...
def generar_kml(filas, output_path):
    ...
    for fila in filas:
        if prev is not None:
            ...
            kml.append(f'        <extrude>1</extrude>')
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("     python generar_kml.py datos_RAM.csv")
        print("     python generar_kml.py datos_simulacion.csv")
        sys.exit(1)
