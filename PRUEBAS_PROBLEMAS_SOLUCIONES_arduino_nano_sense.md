...
### Problema 3: LED Amarillo Parpadea Constantemente
**Síntoma:**
- LED verde (PWR): Encendido ✅
- LED amarillo (RX/TX): Parpadea erraticamente ⚠️
- Arduino IDE: Comunica pero inestable

**Intentos de solución:**
1. ❌ Cambiar cable USB → Problema persiste
2. ❌ Cambiar puerto USB del PC → Problema persiste
3. ❌ Usar hub USB → Empeora
4. ✅ **SOLUCIÓN:** Cable USB de MALA CALIDAD
   - Probado con 3 cables genéricos
   - Todos daban el mismo problema
   - Se necesita cable de marca conocida (Anker, Belkin, etc.)
