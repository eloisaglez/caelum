...
**Intentos de solución:**
1. ✅ **Instalar driver CH340** → NECESARIO para detectar puerto
2. ❌ Cambiar puertos USB → Problema persiste sin driver
3. ❌ Reinstalar Arduino IDE → Sin efecto sin driver correcto
4. ❌ Desinstalar/reinstalar placas → Parcial sin driver
5. ✅ **SOLUCIÓN CORRECTA:** Instalar "Arduino Mbed OS Nano Boards" + Instalar CH340 driver

**Root cause:** Arduino Nano 33 BLE necesita AMBOS:
- Arduino Mbed OS Nano Boards (en Arduino IDE)
- CH340 driver (sistema operativo)
- SIN ambos, no detecta puerto COM
...
### Solución 2: Drivers y Paquetes Necesarios
**Windows - Driver CH340:**
1. Descargar: https://www.wch.cn/downloads/CH341SER_EXE.html
2. Ejecutar como administrador
3. Instalar driver
4. Reiniciar PC

**Arduino IDE - Paquetes:**
1. Tools → Board Manager
2. Buscar: "Arduino Mbed OS Nano Boards"
3. Instalar versión 4.5.0 (o más reciente)
4. Reiniciar Arduino IDE

**Orden correcto:**
1. Instalar CH340 driver en Windows
2. Instalar Arduino Mbed OS Nano Boards en IDE
3. Reiniciar PC y Arduino IDE
4. Conectar Arduino → Debería detectar puerto COM

### Solución 3: Cable USB de Buena Calidad (Recomendado pero no crítico)
...
**Nota:** Con CH340 driver instalado correctamente, cables genéricos FUNCIONAN aunque no sean óptimos.

**NO usar:**
- Cables visiblemente dañados
- Cables muy viejos/desgastados
- Cables que no transporten datos (solo carga)
