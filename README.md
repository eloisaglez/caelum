...
```
CO₂ ALTO + PM2.5 ALTO  → Combustión activa (fuego, motor)
CO₂ ALTO + PM2.5 BAJO  → Respiración/Fermentación (raro exterior)
...
- Gráficas de correlación CO₂ vs PM2.5 para identificar fuentes de combustión
