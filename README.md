...
| Fuente | PM2.5 (µg/m³) | Patrón |
|--------|---------------|--------|
| **Aire limpio** | 0–12 | Constante y bajo |
| **Tráfico / zona urbana** | 12–55 | Aumenta en capas bajas |
| **Industria / incendio** | >55 | Picos en capas concretas |
| **Polvo (sin combustión)** | 50–150 | Solo PM alto, CO₂ constante |
...
|---------|--------|-------------|
| `datos_SD_raw.csv` | Tarjeta MicroSD | Datos crudos (incluye espera) |
