...
| Escritura CSV | datos_SD.csv | ✅ OK | 25 columnas, 1 muestra/segundo |
| Backup RAM | Buffer interno | ✅ OK | Cada 2 segundos |
...
|--------|-------------|-----------|-------|
| Detección de fases | espera → caida_libre → apertura → descenso → tierra | ✅ OK | Basado en aceleración y altitud |
